...
export const ProblemDetailsSchema = z.object({
   ...
   */
  status: z.number().int().min(HTTP_STATUS_MIN).max(HTTP_STATUS_MAX).optional(),
 ...
 * ```
 */
export function createExtendedProblemDetails<Extra extends Record<string, unknown>>(
  details: Partial<ProblemDetails> & Pick<ProblemDetails, "status"> & Extra,
): ExtendedProblemDetails & Extra {
  return ExtendedProblemDetailsSchema.parse({
    type: "about:blank",
    ...details,
  }) as ExtendedProblemDetails & Extra;
}
