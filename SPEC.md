...
T35|x|merge → release workflow publishes 1.0.0 all 5 pkgs, verify via `npm view @batkit/<pkg> version`. CI green (run 29521087792), release green (run 29521153302), all 5 confirmed @ 1.0.0 live on npm|T33,T34
